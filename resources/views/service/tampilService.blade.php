              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                      <h3 class="card-title m-right">Data Keseluruhan Service</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>{{$row->kendaraan->no_pol}}</td>
                                        <td>{{$row->keluhan}}</td>
                                        <td>{{$row->mekanik?->nm_mekanik ?? '-' }}</td>
                                        <td>{{$row->tgl_masuk}}</td>
                                        <td>{{$row->tgl_keluar}}</td>
                                        <td>{{$row->jns_service ? $row->jns_service->nm_jns_service : 'Data Tidak Ada'}}</td>
                                        <td>
